...
hi MatchParen guisp=#a9b7c6 gui=underline

" Cursor word highlight all occurance, nvim 0.8 default use bright red text
hi default CursorWord guisp=#a9b7c6 gui=underline
